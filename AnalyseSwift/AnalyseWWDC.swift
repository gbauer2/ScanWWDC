...
class WWDC {
    ...
    //TODO: Show downloaded videos with no cooresponding entry in WWDC-xxx.txt
    //TODO: Batch mode for multiple years & multiple keywords.

    static let verWWDC = "3.1"

    //MARK:- analyseWWDC 17-158 = 141-lines
    static func analyse(_ str: String, selecFileInfo: FileAttributes) -> (NSAttributedString, String) {
    ...
    static func getWWDCDownloads(fromUrl: URL) -> [String: String] {
    ...
    static func printHeaderCount(header: String, headers: [String: Int]) {
        if !header.isEmpty {
    ...
    static public func copyStringToClipBoard(textToCopy: String) {
    ...
    static func getKeyWordVal(title: String, desc: String, year: Int) -> [String] {
